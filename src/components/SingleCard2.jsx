...
const SingleCard2 = ({ project }) => {
  ...
  return (
    <div>
      <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96 h-72    hover:scale-105 transition-transform hover:bg-stone-200">
        <div className="p-6">
