            ...
            <div className="flex flex-col sm:flex-row md:flex-row  my-10 lg:gap-20  md:gap-10  justify-between items-center">
              <div className="w-full lg:w-7/12 ">
                ...
                <p className="leading-relaxed mt-4 mb-4 ">
                  <span className="font-bold text-[#236A68] text-lg">Mission:</span>{" "}
                 <span className="text-sm">  At BizNest AI, our mission is to democratize Artificial Intelligence and empower businesses worldwide to thrive in an ever-evolving market landscape. We are committed to providing accessible, innovative, and practical AI solutions that drive sustainable growth, efficiency, and competitiveness for our clients.</span>
                </p>
                <p className="text-black  leading-relaxed mt-0 mb-4 ">
                  <span className="font-bold text-[#236A68]">Vision:</span> 
                  <span className="text-sm" >
                  Our vision is to be the leading catalyst for business transformation through AI, shaping a future where every business, regardless of size or industry, can harness the full potential of AI to achieve unprecedented success. We aspire to create a global community of AI-driven businesses, where innovation flourishes, opportunities abound, and prosperity is shared. Through our dedication to excellence, collaboration, and continuous learning, we aim to inspire and empower businesses to embrace AI as a cornerstone of their success.
                  </span>
