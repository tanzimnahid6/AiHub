      ...
      <div>
        ...
        <ul className="list-image ">
          <li className="flex gap-4 py-3">
            ...
            and growth in businesses worldwide through the transformative power
            of Artificial Intelligence (AI). Our mission is simple yet profound:
            to empower businesses, both new and existing, to thrive in today's
            dynamic market landscape by harnessing the potential of AI
            technology.
          </li>
